...
class _StrikesMappingState extends State<StrikesMapping> {
  late List<Strike> _boxingAttacks = [
    ...
    Strike('3', 'Front Hook', '3'),
    Strike('b3', 'Front Hook Body', 'b3'),
    Strike('4', 'Rear Hook', '4'),
    Strike('b4', 'Rear Hook Body', 'b4'),
    Strike('5', 'Front Uppercut', '5'),
    Strike('6', 'Rear Uppercut', '6'),
  ];
  ...
  late List<Strike> _kickBoxingAttacks = [
    ...
    Strike('rlk', 'Rear Low Kick', 'Rear Low Kick'),
